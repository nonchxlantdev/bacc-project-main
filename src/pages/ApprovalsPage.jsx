              ...
              >
                ...
                <div className="flex shrink-0 items-center gap-2">
                  {row.entity?.href && (
                    <Link
                      to={row.entity.href}
                      className="inline-flex min-h-11 flex-1 items-center justify-center rounded-md border border-line/20 px-3 text-sm text-primary hover:bg-surface-2 desk:min-h-9 sm:flex-none"
                    >
                      Open
                    </Link>
                  )}
                  <button
                    type="button"
                    className="min-h-11 flex-1 rounded-md bg-navy px-3 py-1.5 text-sm font-semibold text-white desk:min-h-9 sm:flex-none"
                    onClick={() => {
                      setActive(row);
                      setError(null);
                    }}
