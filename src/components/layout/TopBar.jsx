      ...
      <div className="flex shrink-0 items-center gap-1 sm:gap-3">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="flex min-h-11 items-center gap-3 rounded-md px-1 py-1 hover:bg-white/10 sm:px-2"
          >
          ...
          {menuOpen && (
            <div
              role="menu"
              className="absolute right-0 z-30 mt-2 w-64 max-w-[calc(100vw-1rem)] overflow-hidden rounded-md border border-navy/10 bg-white text-navy shadow-lg"
            >
